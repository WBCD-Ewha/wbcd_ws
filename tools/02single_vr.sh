...
# /home/arx/桌面/sdk/R5Pro_SDK_KDL/ROS/R5Pro_ws/tools/02single_vr.sh

gnome-terminal -t "can1" -x bash -c "cd ${workspace}/../../..;cd ARX_CAN/arx_can; ./arx_can1.sh; exec bash;"
sleep 1s
# R5Pro
gnome-terminal -t "R5Pro" -x  bash -c "cd ${workspace}/..; source devel/setup.bash && roslaunch arx_r5pro_controller open_vr_single_arm.launch; exec bash;"
